...
from api.queries import listTeams_resolver,getTeam_ByName_resolver,listRegions_resolver,listPlayers_resolver,getPlayer_ByName_resolver,getTeam_ByRegion_resolver,getPlayer_ByPseudo_resolver,listTransfert_resolver,listMatches_resolver
...
query.set_field("listAllMatches", listMatches_resolver)
